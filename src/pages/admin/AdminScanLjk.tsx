...
export default function AdminScanLjk() {
    ...
    <div className="flex flex-col min-h-screen bg-slate-950 font-sans text-slate-100">
      <div className="p-4 flex items-center justify-between border-b border-slate-800 bg-slate-900/50 backdrop-blur">
        <div className="flex items-center gap-3">
           <Button variant="ghost" size="icon" className="hover:bg-slate-800 focus:bg-slate-800" onClick={() => navigate('/admin')}>
              <ChevronLeft className="w-5 h-5" />
           </Button>
           <div>
              <h1 className="font-bold text-lg leading-tight flex items-center gap-2">
                 <ScanLine className="w-5 h-5 text-emerald-400" /> Scanner LJK OMR
              </h1>
      ...
      <div className="flex-1 flex flex-col md:flex-row relative">
         ...
         <div className="md:w-80 w-full bg-slate-900 border-l border-slate-800 p-6 flex flex-col gap-6 z-20 overflow-y-auto">
            <div>
               <label className="text-xs font-bold text-slate-400 mb-2 block uppercase tracking-wider">Target Ujian (Kunci Jawaban)</label>
